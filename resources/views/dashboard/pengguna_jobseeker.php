        ...
        <main class="content px-3 py-5 mt-5">
            ...
            <div class="container-fluid">
                <div class="mb-3">
                    ...
                    <h3 class="fw-bold fs-4 mb-3 mt-2">Daftar Job Seeker</h3>
                    <div class="row mb-5">
                        <div class="col-12">
                            <div class="row">
                                <div class="col-6">
                                    <small class="text-muted pb-2">Berikut adalah daftar job seeker</small>
                                </div>
                            </div>
            ...
            <div class="container-fluid">
                <div class="mb-3">
                    <h3 class="fw-bold fs-4 mb-3 mt-2">Job Seeker yang dinonaktifkan</h3>
                    <div class="row mb-5">
                        <div class="col-12">
                            <div class="row">
                                <div class="col-6">
                                    <small class="text-muted pb-2">Berikut adalah daftar job seeker yang dinonaktifkan</small>
                                </div>
                            </div>
