        ...
        <main class="content px-3 py-5 mt-5">
            ...
            <div class="container-fluid">
                <div class="mb-3">
                    ...
                    <a href="<?= urlpath('dashboard/pengguna/jobseeker') ?>"><i class="fa fa-arrow-left"></i>
                        Kembali</a>
                    ...
                    <div class="modal fade" id="confirmationModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="confirmationModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-footer">
                                ...
                                <form action="<?= urlpath('dashboard/pengguna/jobseeker/detailjobseeker/nonaktifkan_jobseeker') ?>" method="POST">
