    ...
    <div class="main">
        ...
        <main class="content px-3 py-5 mt-5">
            <div class="container-fluid">
                <div class="mb-3">
                    <h3 class="fw-bold fs-4 mb-3">Daftar Loker Aktif</h3>
                    <div class="row mb-5">
                        <div class="col-12">
                            <div class="row">
                                <div class="col-6">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="editlokerForm">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="f" name="f" rows="5"></textarea>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <div id="dropbox" class="custom-file-container"
                                                ...
                                                <p class="text-muted dropbox-default-label">Drag & Drop Foto / Poster
                                                    disini, atau klik untuk memilih file</p>
                                                <input name="g" id="image-upload" type="file" accept="image/*"
                                                    class="d-none" onchange="handleFileSelect(event)">
                                                <div class="file-name"></div>
                                                <p class="mt-2 text-muted"> Berikut Foto / Poster yang anda gunakan
                                                    sebelumnya</p>
                                                <img id="image-preview" class="image-preview d-none" src="">
                                                <button type="button" id="clear-button" class="btn clear-button d-none"
                                                    onclick="handleClearButtonClick(event)"><i
                                                        class="bi-x"></i></button>
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-primary save-button" id="saveChanges">Save
                                        changes</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <h3 class="fw-bold fs-4 mb-3">Daftar Loker Non-Aktif</h3>
                    <div class="row">
                        <div class="col-12">
                            ...
                            <table class="table table-striped">
                                <thead>
                                    <tr class="highlight">
                                        ...
                                        ?>
                                        <th scope="col">Dinonaktifkan pada</th>
                                    </tr>
                                </thead>
                                <tbody id="dashboardinactiveTableBody">
                                </tbody>
                            </table>
                        </div>
                    </div>
